...
const GeneratePodcast = (props: GeneratePodcastProps) => {
  ...
  return (
    <div>
      ...
      <div>
        <div className="mt-5 w0full max-w-[200px]">
        <Button type="submit" className="text-16 bg-orange-1 py-4 font-bold text-white-1 transition-all" onClick={generatePodcast}>
          {isGenerating ? (
            <>
              Generating
